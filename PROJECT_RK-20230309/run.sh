...
# adb push lib/daHuaCam/*.so /userdata/                                                                                   # 将大dahua提供的SDK库push到开发板userdata下面
...
# adb shell "mkdir -p /userdata/lib"                                                 # 在 userdata/ 下创建 lib 文件夹，
...
#adb push models/resnet.rknn /userdata/models/                                     # 将检测模型push到models文件夹下
#adb push models/resnet-bll.rknn /userdata/models/                                     # 将检测模型push到models文件夹下
...
# adb push data/test.jpg /userdata/data/                                           # 在data文件夹中push一张测试图用于离线测试
