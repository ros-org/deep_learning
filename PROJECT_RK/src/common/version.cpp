...
{
    const char* detectionModelVersion = "v1.1.0";
...
{
    const char* detection2ModelVersion = "v1.1.0";
...
{
    const char* weatherModelVersion = "v3.0.0";
...
{
    const char* clealinessModelVersion = "v3.0.0";
