...
///@brief 事件类型EVENT_IVS_FACERECOGNITION(人脸识别)对应的规则配置
...
///@brief 事件类型EVENT_IVS_TRAFFICCONTROL(交通管制事件)对应的规则配置
...
///@brief 事件类型EVENT_IVSS_FACECOMPARE(IVSS人脸识别事件) 对应的规则配置
...
///@brief 事件类型 EVENT_IVS_PRISONERRISEDETECTION (看守所起身检测事件)对应的规则配置
...
///@brief 事件类型 EVENT_IVS_GETOUTBEDDETECTION(看守所下床事件)对应规则配置
...
///@brief 平台侧监视IPC配置 CFG_CMD_PLATFORM_MONITOR_IPC
...
///@brief 网络监视中断事件配置( 对应结构体 CFG_NET_MONITOR_ABORT_INFO )
