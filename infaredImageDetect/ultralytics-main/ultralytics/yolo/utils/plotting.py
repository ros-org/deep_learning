...
class Colors:
    ...
    def __init__(self):
        ...
        hexs_org = ('FF3838', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
                '2C99A8', '00C2FF', '344593', '6473FF', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8', 'FF37C7')
        hexs = ('FF0000', '00FF00', '0000FF', 'FFFF00', '00FFFF', 'FF00FF', '800000', '008000', '000080', '808000',
                '008080', '800080', 'FF8000', '00FF80', '8000FF', '204060', '206040', '602040', '604020', '406020')
        self.palette = [self.hex2rgb(f'#{c}') for c in hexs]
        self.n = len(self.palette)  # 设置了20种颜色
    ...
    def __call__(self, i, bgr=False):
        ...
        c = self.palette[int(i) % self.n]    # 从20种颜色中取一种
