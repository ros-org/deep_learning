#! /usr/bin/env python3
# -*- coding: utf-8 -*-
"""本模块用于确定搜索最佳学习率，使得 YOLOv8 检测模型在最少的 epochs 之内，能得到最大的 mAP50 指标值。
...
def main(detect_data, batch_size=8, optimizer='SGD',
    ...
    print(f'{detect_data= }')
    model_path = f'/media/drin/shared_disk/work/cv/2023_06_07_connector/pretrained_models/yolov8{model_type}.pt'
...
if __name__ == '__main__':
    ...
    # predict_on_conf_iou(model_path=model_path, conf=0.5, iou=0.7,
